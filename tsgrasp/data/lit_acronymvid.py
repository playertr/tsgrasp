...
class LitAcronymvidDataset(pl.LightningDataModule):
    ...
    def val_dataloader(self):
        return DataLoader(self.dataset_val, batch_size=self.batch_size, num_workers=self.num_workers, collate_fn=minkowski_collate_fn,  sampler=RandomSampler(self.dataset_val, int(len(self.dataset_val) / self.data_cfg.subset_factor)))
